...
from teamml_audio_aug import AddBackgroundNoise
from tests.utils import fast_autocorr, TEST_RES_DIR
...
def test_add_background_noise():
    ...
    augmenter = AddBackgroundNoise(
        sounds_path=os.path.join(TEST_RES_DIR, "background_noises"),
        min_snr_db=15.0,
        max_snr_db=35.0,
        p=1.0,
    )
...
def test_background_noise_offset_variation():
    ...
    sample_rate = 44100
    noise_path = os.path.join(TEST_RES_DIR, "background_noises", "hens.ogg")
...
def test_try_add_almost_silent_file():
    ...
    sample_rate = 48000
    augmenter = AddBackgroundNoise(
        sounds_path=os.path.join(TEST_RES_DIR, "almost_silent"),
        min_snr_db=15,
        max_snr_db=35,
        p=1.0,
    )
...
def test_try_add_digital_silence():
    ...
    sample_rate = 48000
    augmenter = AddBackgroundNoise(
        sounds_path=os.path.join(TEST_RES_DIR, "digital_silence"),
        min_snr_db=15,
        max_snr_db=35,
        p=1.0,
    )
